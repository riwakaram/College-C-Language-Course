 ...
 * Author: riwakaram
 *
 * Created on November 14, 2021, 4:48 PM
 */
...
/* 
 * Simulates tossing an unbiased coin n times.
 ...
 */
void performExperiment(int *nOccur, int nTosses, int nTrials) {
    if (!nOccur) return;
...
int main(int argc, char ** argv) {
    // Zeroth argument: name of the executable
    // First argument: nTosses
    // Second argument: nTrials
    // If different, print usage an quit
    if (argc != 3) {
        printUsage();
        return (EXIT_FAILURE);
    }
