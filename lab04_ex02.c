 ...
 * Author: riwakaram
 *
 * Created on November 1, 2021, 8:57 AM
 */
 ...
 * elements of the rows reversed
 * Returns -1 for incorrect input and 0 for success
 */
int copy_rows_reversed(int row, int col, int a[row][col], int b[row][col]) {
...
int main(int argc, char** argv) {
    ...
    printf("The copy array of the original one with the rows reversed is: \n");
    copy_rows_reversed(rows, cols, a, b);
